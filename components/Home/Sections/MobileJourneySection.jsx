...
export default function MobileJourneySection({ index = 1 }) {
    const section = {
        title: 'PokeHex',
    ...
    return (
        <div className="relative capitalize">
            ...
            <div className={'relative h-screen flex flex-col justify-center items-center text-white text-center'}>
                <div className="absolute inset-0 bg-[url('/images/home/xl/mobile/mobile-pokemon-journey-xl.png')] bg-repeat-round bg-contain z-0"></div>

                <div className="flex flex-col gap-20 z-10 justify-center h-full items-center py-[25%]">
                    <div className="flex flex-col gap-4 items-center justify-center">
                        <div className="flex flex-col">
                            <h1 className="text-xl">Every Journey</h1>
                            <h1 className="text-2xl">Begins with a Choice</h1>
                        </div>
                        <p className="text-3xs max-w-2xl px-[15%]">{section.desc}</p>
                    </div>

                    <div className="w-full h-80 px-[12%]">
                        <Image
                            src={PokemonBag}
                            alt="pokemon bag"
